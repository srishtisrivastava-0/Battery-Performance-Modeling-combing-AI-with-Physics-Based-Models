...
def load_data(battery):
    ...
    import os
    possible_paths = [
        'datasets/battery_data/' + battery + '.mat',  # From project root
        '../datasets/battery_data/' + battery + '.mat',  # From subdirectory
        '../../datasets/battery_data/' + battery + '.mat',  # From nested subdirectory
    ]
    ...
    if mat is None:
        raise FileNotFoundError(
            f"Could not find {battery}.mat in any of these locations:\n" +
            "\n".join(possible_paths) +
